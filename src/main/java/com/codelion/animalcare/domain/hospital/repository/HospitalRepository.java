...
public interface HospitalRepository extends JpaRepository<Hospital, Long> {
    ...
    @Query("select h from Hospital h where :minLatitude < h.address.latitude and h.address.latitude < :maxLatitude and :minLongitude < h.address.longitude and h.address.longitude < :maxLongitude")
